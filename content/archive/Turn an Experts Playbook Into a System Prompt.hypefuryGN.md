...
- "what I did is I just went ahead and I took a bunch of screenshots of every single one of these pages"
- "You are an expert in social media, especially LinkedIn. I'm going to give you some images that describe what makes effective LinkedIn posts. I need you to thoroughly read and understand these, then wait for further instruction."
- "You are an expert LinkedIn content strategist specializing in creating viral, highconverting LinkedIn posts. Your task is to transform any given topic and context into a compelling LinkedIn post that drives maximum engagement, builds authority, and generates leads."
