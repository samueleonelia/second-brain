...
- [[Coding Agents Are Knowledge Work Agents in Disguise]] -- the human-side payoff of this architecture: files+shell is why a "coding" agent generalizes to any knowledge worker's substrate
