...
The most interesting search intents for most affiliates are **commercial**and **informational.** 
If you run an eCommerce store, **transactional** is very interesting too.
The simplest way to figure out the search intent is to Google a keyword and see what’s ranking. In this case, we have already looked at the SERP when Googling “horse snacks”.
