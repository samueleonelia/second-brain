...
- [[The Nine-Month Wait, 200 Posts]] -- Olivia Wickstrom: the same compounding-before-traction pattern, framed as her overall arc
- [[9,200 Subscribers from One-Way Substack Recommendations]] -- Tom Orbach: the inverse-lever Olivia abandoned (recommendations) used systematically
- [[The Elon and Cathie Wood Retweets That Doubled His Following]] -- Yossi Levi: a single viral moment doubling an audience after slow growth
- [[The 50 Threads in 50 Days Challenge]] -- Alex Garcia: cadence challenge as Twitter's equivalent discovery-layer mechanic
- [[18,500 Tweets in 489 Days]] -- the volume-as-input version of the same discovery bet
