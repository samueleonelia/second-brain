...
1. **Reddit** — directly, plus a tool called GigaBrain ("perplexity meets Reddit and it does an awesome job of like doing all that manual teasing out") (Source 1).
2. **Organic social** — looking at Instagram and TikTok feeds for hook ideas (Source 1).
3. **Competitor ads** (Source 1).
4. **Internal first-party data** — "looking at what subject lines were your highest opened and what content was in those emails. Which links were clicked the most? Throw that all into ChatGPT. Have it tease out themes and then write your ads around those themes" (Source 1).
